...
openai.api_key = "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"
...
def exec_steps(whole_task, instruction_task=None, task_id=None):
    save_file = whole_task.replace(" ", "_").replace(".", "") + ".txt"
    ...
    if os.path.exists(save_file) and reuse:
        ...
        while True and trials < 5:
            if instruction_task is not None:
                ...
                curr_prompt = insert_task_into_prompt(whole_task, prompt_base)
